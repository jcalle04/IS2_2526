 ...
 * - WMC = 18
 *   - main(...) = 17 = 1 (base) + 1 (while) + 4 (case del primer switch) + 1 (if)
 *     + 1 (if) + 3 (case del segundo switch) + 1 (if) + 1 (for) + 1 (if)
 *     + 1 (else if) + 1 (if) + 1 (for)
 *   - mensaje(...) = 1
 * - WMCn = 18 / 2 = 9.0
 * - CCog = 34
 *   - main(...) = 34 = 1 (while) + 2 (switch anidado) + 3 (if anidado)
 *     + 3 (if anidado) + 4 (switch anidado) + 1 (else)
 *     + 3 (if anidado) + 1 (else) + 3 (for anidado) + 4 (if anidado)
 *     + 1 (else if) + 3 (if anidado) + 1 (else) + 4 (for anidado)
 *   - mensaje(...) = 0
 * - CCogn = 34 / 2 = 17.0
 */
